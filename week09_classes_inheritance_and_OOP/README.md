...
Welcome to week 9 of this course!
...
* **Attributes** (e.g., a `Car` class might have color and maximal speed).
...
1. Design a class for your final project that has at least:
 ...
 are working on one of the pre-defined final projects). Note that you don’t have 
 to stick to the provided data format or shape, you can organize/store it 
 differently based on your system design.
    * one method that is useful for your final project.
2. Write your code (the code for the class in `src` and script that create
...
Considering the OOP (object-oriented programming) principles you have learned
...
* Please use **proper Docstrings and Comments** in your script, make it 
easy for others to understand your code.

* Remember to **version control** the whole process, incrementally add, 
commit and push the changes along the way, use PRs properly.

**The thinking part is the fun and rewarding part!** 

**Don't outsource it to others.**